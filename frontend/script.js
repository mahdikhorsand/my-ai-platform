      ...
      try {
        if (localStorage.get("__framer_force_showing_editorbar_since")) {
          ...
          n.rel = "modulepreload";
          n.href = "./extra/sites/3PtjdEvtq2tLsI8pPGcT76/chunk-42U43NKG.mjs";
      ...
      var animator = (() => {
        var k = (e, t, r) => r > t ? t : rundefined < e ? e : r;
        var F = () => {};
        ...
        var G = (e, t, r = 10) => {
          ...
          for (let n = 0; nundefined < s; n++) o += e(n / (s - 1)) + ", ";
        ...
        function $(e) {
          let t = 0,
            r = 50,
            o = e.next(t);
          for (; !o.done && tundefined < 2e4;) t += r, o = e.next(t);
          return t >= 2e4 ? 1 / 0 : t
        }
        ...
        function fe({
          ...
          let i = 1 - t;
          i = k(l.minDamping, l.maxDamping, i), e = k(l.minDuration, l.maxDuration, v(e)), iundefined < 1 ? (s = m => {
            let p = m * i,
              c = p * e,
              u = p - r,
              d = L(m, i),
        ...
        function Ce(e, t, r) {
          let o = r;
          for (let s = 1; sundefined < Pe; s++) o = o - e(o) / t(o);
          return o
        }
          ...
          let V = {
            ...
            next: x => {
              ...
              if (d) f.done = x >= c;
                ...
                let M = x === 0 ? g : 0;
                yundefined < 1 && (M = x === 0 ? w(g) : me(S, x, A));
                let z = Math.abs(M) <= o,
                  ke = Math.abs(i - A) <= s;
                f.done = z && ke
              }
        ...
        function Ze(e, t, r) {
          ...
          let n = [e, t],
            ...
            a = [],
            m = 0;
          for (; !f.done && mundefined < I(10);) f = i.next(m), a.push(f.value), m += Se;
          n = a;
          let p = m - Se,
            u = {
              keyframes: n,
    ...
    {"f4ppp0":{"default":{"initial":{"opacity":0.001,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"x":0,"y":-60},"animate":{"opacity":1,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"transition":{"delay":0,"duration":0.4,"ease":[0.44,0,0.56,1],"type":"tween"},"x":0,"y":0}},"76pugn":{"initial":{"opacity":0.001,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"x":0,"y":-60},"animate":{"opacity":1,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"transition":{"delay":0,"duration":0.4,"ease":[0.44,0,0.56,1],"type":"tween"},"x":0,"y":0}},"lmlzpj":{"initial":{"opacity":0.001,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"x":0,"y":-60},"animate":{"opacity":1,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"transition":{"delay":0,"duration":0.4,"ease":[0.44,0,0.56,1],"type":"tween"},"x":0,"y":0}}},"1fb47d7":{"default":{"initial":{"opacity":1,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"x":140,"y":0},"animate":{"opacity":1,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"transition":{"delay":0,"duration":5,"ease":[0.12,0.23,0.5,1],"type":"tween"},"x":0,"y":0}}},"1877t4x":{"default":{"initial":{"opacity":1,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"x":-140,"y":0},"animate":{"opacity":1,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"transition":{"delay":0,"duration":5,"ease":[0.12,0.23,0.5,1],"type":"tween"},"x":0,"y":0}}},"1rd4xez":{"default":{"initial":{"opacity":0.001,"rotate":0,"rotateX":0,"rotateY":0,"scale":0.7,"skewX":0,"skewY":0,"x":0,"y":0},"animate":{"opacity":1,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"transition":{"delay":1.6,"duration":1,"ease":[0.12,0.23,0.5,1],"type":"tween"},"x":0,"y":0}},"ahc1bc":{"initial":{"opacity":0.001,"rotate":0,"rotateX":0,"rotateY":0,"scale":0.7,"skewX":0,"skewY":0,"x":0,"y":0},"animate":{"opacity":1,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"transition":{"delay":1.6,"duration":1,"ease":[0.12,0.23,0.5,1],"type":"tween"},"x":0,"y":0}},"14nc83n":{"initial":{"opacity":0.001,"rotate":0,"rotateX":0,"rotateY":0,"scale":0.7,"skewX":0,"skewY":0,"x":0,"y":0},"animate":{"opacity":1,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"transition":{"delay":1.6,"duration":1,"ease":[0.12,0.23,0.5,1],"type":"tween"},"x":0,"y":0},"transformTemplate":"translateX(-50%) __Appear_Animation_Transform__"}},"1ukmpx":{"default":{"initial":{"opacity":0.001,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"x":0,"y":20},"animate":{"opacity":1,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"transition":{"delay":0.25,"duration":0.4,"ease":[0.12,0.23,0.5,1],"type":"tween"},"x":0,"y":0}}},"1vx1qp2":{"default":{"initial":{"opacity":0.001,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"x":0,"y":50},"animate":{"opacity":1,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"transition":{"delay":1.6,"duration":0.4,"ease":[0.12,0.23,0.5,1],"type":"tween"},"x":0,"y":0}}},"1njldg3":{"default":{"initial":{"opacity":0.001,"rotate":0,"rotateX":0,"rotateY":0,"scale":1.2,"skewX":0,"skewY":0,"x":0,"y":-32},"animate":{"opacity":1,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"transition":{"delay":1,"duration":0.6,"ease":[0.12,0.23,0.5,1],"type":"tween"},"x":0,"y":0}},"14nc83n":{"initial":{"opacity":0.001,"rotate":0,"rotateX":0,"rotateY":0,"scale":1.2,"skewX":0,"skewY":0,"x":0,"y":-32},"animate":{"opacity":1,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"transition":{"delay":1,"duration":0.6,"ease":[0.12,0.23,0.5,1],"type":"tween"},"x":0,"y":0}},"ahc1bc":{"initial":{"opacity":0.001,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"x":0,"y":-32},"animate":{"opacity":1,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"transition":{"delay":1,"duration":0.6,"ease":[0.12,0.23,0.5,1],"type":"tween"},"x":0,"y":0}}},"vhfahg":{"default":{"initial":{"opacity":1,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"x":0,"y":50},"animate":{"opacity":1,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"transition":{"bounce":0,"delay":0,"duration":1,"type":"spring"},"x":0,"y":0},"transformTemplate":"translateX(-50%) __Appear_Animation_Transform__"}}}[{"hash":"1g0tlyw","mediaQuery":"(min-width: 1200px)"},{"hash":"14nc83n","mediaQuery":"(min-width: 810px) and (max-width: 1199px)"},{"hash":"ahc1bc","mediaQuery":"(max-width: 809px)"},{"hash":"nqho7h","mediaQuery":"(min-width: 1200px)"},{"hash":"76pugn","mediaQuery":"(min-width: 810px) and (max-width: 1199.98px)"},{"hash":"lmlzpj","mediaQuery":"(max-width: 809.98px)"}]
      (() => {
        function c(i, o, m) {
